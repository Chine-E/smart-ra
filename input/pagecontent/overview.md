...
#### Priority Health Sector Goals defining a DPI Reference Architecture for National Digital Health Transformation

In using the proposed DPI Reference Architecture for National Digital Health Transformation, countries will be aiming to achieve their broader national health system goals. These goals can include, but are not limited to: 
